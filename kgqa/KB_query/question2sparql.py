...
if __name__ == '__main__':
    q2s = Question2Sparql(['E:/QA_System/KGQA-Based-On-medicine-master/kgqa/KB_query/dict/jibing_pos_name.txt', 'E:/QA_System/KGQA-Based-On-medicine-master/kgqa/KB_query/dict/drug_pos_name.txt', 'E:/QA_System/KGQA-Based-On-medicine-master/kgqa/KB_query/dict/symptom_pos.txt'])
    #question = '喉插管损伤有什么症状？'
