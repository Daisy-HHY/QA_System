...
if __name__ == '__main__':
    tagger = Tagger(['E:/QA_System/KGQA-Based-On-medicine-master/kgqa/KB_query/dict/jibing_pos_name.txt', 'E:/QA_System/KGQA-Based-On-medicine-master/kgqa/KB_query/dict/drug_pos_name.txt'])
    #while True:
    s = '喉插管损伤需要什么药治疗？'
